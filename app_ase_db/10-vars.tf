...
variable "ebs_sapmnt_size"      {}
variable "ebs_sapdata_size"     {}
variable "ebs_sybase_size"      {}
variable "ebs_saplog_size"      {}
...
variable "user_data_file_path"         { default = "../localmodules//tf-aws-sap-ha/include/userdata_app_ase_db.tmpl" }
